	...
	public EsResponse<ParkingLocationDto> getParkingInfo(long parkingId, long vehicleTypeId) {
		try {
			...
			if(!objList.isEmpty()) {
					...
					parkingLocDTO = new ParkingLocationDto((Long)obj[0],  (double)obj[6], (double)obj[7], (double)obj[5], obj[4].toString(),obj[1].toString(),obj[2].toString(),obj[3].toString(),obj[8].toString());
